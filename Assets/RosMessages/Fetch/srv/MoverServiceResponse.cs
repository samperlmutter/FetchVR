...
namespace RosMessageTypes.Fetch
{
    ...
    public class MoverServiceResponse : Message
    {
        ...
        public RobotTrajectoryMsg[] trajectories;

        public MoverServiceResponse()
        {
            this.trajectories = new RobotTrajectoryMsg[0];
        }

        public MoverServiceResponse(RobotTrajectoryMsg[] trajectories)
        {
        ...
        {
            deserializer.Read(out this.trajectories, RobotTrajectoryMsg.Deserialize, deserializer.ReadLength());
        }

...
"""autogenerated by genpy from fetch_msgs/MoverServiceRequest.msg. Do not edit."""
import codecs
import sys
...
import fetch_msgs.msg
import geometry_msgs.msg
import std_msgs.msg

class MoverServiceRequest(genpy.Message):
  _md5sum = "cf858f0e302c1c84dd88255ac9fe40bc"
  _type = "fetch_msgs/MoverServiceRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """FetchMoveitJoints joints_input
...
float64 w
"""
  __slots__ = ['joints_input','pose']
  _slot_types = ['fetch_msgs/FetchMoveitJoints','geometry_msgs/PoseStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.joints_input is None:
        self.joints_input = fetch_msgs.msg.FetchMoveitJoints()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_7d().pack(*self.joints_input.joints))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints_input.joints = _get_struct_7d().unpack(str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joints_input.joints = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=7)
      _x = self
      start = end
      end += 12
      (_x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from fetch_msgs/MoverServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class MoverServiceResponse(genpy.Message):
  ...
  _type = "fetch_msgs/MoverServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """RobotTrajectory[] trajectories
...
"""
  ...
  _slot_types = ['fetch_msgs/RobotTrajectory[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = fetch_msgs.msg.RobotTrajectory()
...
class MoverService(object):
  _type          = 'fetch_msgs/MoverService'
  _md5sum = '52a2bd437a86fe11986eb188dd11aaf2'

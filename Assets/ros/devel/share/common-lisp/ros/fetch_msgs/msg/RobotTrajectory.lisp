...
(cl:defmethod cl:initialize-instance :after ((m <RobotTrajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotTrajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fetch_msgs-msg:<RobotTrajectory> is deprecated: use fetch_msgs-msg:RobotTrajectory instead.")))

(cl:ensure-generic-function 'joint_trajectory-val :lambda-list '(m))
(cl:defmethod joint_trajectory-val ((m <RobotTrajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fetch_msgs-msg:joint_trajectory-val is deprecated.  Use fetch_msgs-msg:joint_trajectory instead.")
  (joint_trajectory m))
...
(cl:defmethod multi_dof_joint_trajectory-val ((m <RobotTrajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fetch_msgs-msg:multi_dof_joint_trajectory-val is deprecated.  Use fetch_msgs-msg:multi_dof_joint_trajectory instead.")

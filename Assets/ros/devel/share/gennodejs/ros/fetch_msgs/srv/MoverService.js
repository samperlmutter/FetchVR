...
class MoverServiceRequest {
  ...
  static Resolve(msg) {
    ...
    if (msg.joints_input !== undefined) {
      resolved.joints_input = FetchMoveitJoints.Resolve(msg.joints_input)
    }
    else {
...
class MoverServiceResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.trajectories[i] = RobotTrajectory.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'fetch_msgs/MoverServiceResponse';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.trajectories !== undefined) {
      ...
      for (let i = 0; i < resolved.trajectories.length; ++i) {
        resolved.trajectories[i] = RobotTrajectory.Resolve(msg.trajectories[i]);
      }
    }
    else {
